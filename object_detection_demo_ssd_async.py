...
def main():
    ...
    # Read IR
    log.info("Reading IR...")
    net = IENetwork(model='/opt/intel/computer_vision_sdk_2018.5.445/deployment_tools/intel_models/person-vehicle-bike-detection-crossroad-0078/FP16/person-vehicle-bike-detection-crossroad-0078.xml', weights='/opt/intel/computer_vision_sdk_2018.5.445/deployment_tools/intel_models/person-vehicle-bike-detection-crossroad-0078/FP16/person-vehicle-bike-detection-crossroad-0078.bin')
    net2 = IENetwork(model='/opt/intel/computer_vision_sdk_2018.5.445/deployment_tools/intel_models/person-vehicle-bike-detection-crossroad-0078/FP16/person-vehicle-bike-detection-crossroad-0078_.xml', weights='/opt/intel/computer_vision_sdk_2018.5.445/deployment_tools/intel_models/person-vehicle-bike-detection-crossroad-0078/FP16/person-vehicle-bike-detection-crossroad-0078_.bin')
    ...
    while cap.isOpened():
        try:
            ...
            exec_net2.start_async(request_id=next_request_id, inputs={input_blob2: in_frame2})
            ...
            if countt%2==0 and exec_net.requests[cur_request_id].wait(-1) == 0:
                print("1 has result")
            ...
            cur_request_id, next_request_id = (cur_request_id+1)%max_request, (next_request_id+1)%max_request
